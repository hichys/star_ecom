<template>
  <router-link :to="{
    ...
    class="w-full bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 flex flex-col h-full"
  >
    <!-- Image -->
    <a href="#">
      <img
        class="p-8 rounded-t-lg mx-auto max-h-48 object-contain"
        :src="props.image"
        alt="product image"
      />
    </a>
    ...
    <!-- Body -->
    <div class="flex flex-col justify-between flex-1 px-5 pb-5">
      <div>
        <a href="#">
          <h5
